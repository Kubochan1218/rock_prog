...
import datetime, openpyxl, re, os, sys, tkinter as tk, tkinter.font as tkfont, pandas as pd
from tkinter import messagebox, simpledialog, filedialog, ttk
import band_selection as bs, attendance_calculation as ac
...
class AttendanceApp:
    ...
    def show_top(self):
        ...
        btn_register.pack(padx=10, ipadx=10, ipady=8)
